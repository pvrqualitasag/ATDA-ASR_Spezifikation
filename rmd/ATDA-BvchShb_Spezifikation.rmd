...
objSecEnum$displayNumSection()
```
Dieses Projekt befasst sich mit dem automatisierten Tierdatenaustausch. 

```{r echo=FALSE,results='asis'}
objSecEnum$setUnNumSection(psUnNumSection = 
"### Software-System für den automatisierten Datenaustausch (SSAD)")
objSecEnum$parseUnNumSection()
objSecEnum$displayNumSection()
```
Das Endprodukt dieses Projektes
