...
# Erklärung
Dieses Dokument enthält die Spezifikation für das Projekt zum automatisierten Tierdatenaustausch (ATDA), welches von der Arbeitsgruppe zuchttechnische Dienstleistungen der Arbeitsgemeinschaft Schweizer Rinderzüchter (ASR) in Auftrag gegeben wurde.

Da die Umsetzung dieses Projektes sehr stark von den technischen Gegebenheiten der Anbieter von Melkanlagen abhängt, ist diese Spezifikation in gewissen Abschnitten noch nicht sehr konkret gefasst. Dies ist eine bewusste Entscheidung, welche die Offenheit und die Flexibilität von unserer Seite her demonstrieren soll. Das erste Informationstreffen mit den Anbietern von Melkanlagen ist auf den 18. März 2016 angesetzt. Vor diesem Treffen fehlen uns die Informationen, welche für eine konkretere Ausformulierung dieser Spezifikation und eine seriöse Planung des Projektes für den Zeitraum nach dem 18.3.2016, nötig wären. 
...
objSecEnum$displayNumSection()
```
Das folgende Diagramm zeigt einen ungefähren Plan, wie sich die bis zu aktuellen Zeitpunkt bekannten Themen auf das erste Halbjahr 2016 aufteilen lassen. Wichtig ist die Tatsache, dass dieser Projektpan nicht Mitte 2016 aufhört, weil das Projekt dann abgeschlossen sein wird, sondern, weil wir aufgrund des aktuellen Informationsstandes den weiteren Projektverlauf für das zweite Halbjahr 2016 aktuell noch nicht planen können. 

Ein wichtiger Termin in der Projektplanung von ATDA-ASR (siehe gelber markierte Kolonne im Diagramm) stellt der 18.3.2016 dar. An diesem Datum findet ein Treffen am runden Tisch mit allen Anbietern der Melkrobotern statt. Dieses Treffen dient dazu, technische Fragen zu klären, welche die Umsetzung des Datentransfers wesentlich beeinflussen. Vor diesem Treffen ist somit eine konkrete Planung des gesamten Projektes unmöglich. 

In der verbleibenden Zeit vor dem Treffen vom 18.3.2016, konzentrieren wir uns auf erste Abklärungen mit den Melkroboteranbieter, auf die Spezifikation diese Projektes (ATDA-ASR) und auf das Erstellen einer Testumgebung für die Datenübertragung mit einer ausgewählten Fernwartungslösung. Die Planung der Umsetzung der weiteren Projektthemen ist zu diesem Zeitpunkt noch sehr spekulativ, da die konkrete Umsetzung der Datenübertragung von den Ergebnissen des Treffens am 18.3.2016 abhängt. Aus diesem Grund werden im folgenden Plan auch die gelb markierten Themen als Alternativen doppelt geführt.
